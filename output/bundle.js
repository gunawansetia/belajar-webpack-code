...
/* harmony export */   "default": () => (/* binding */ AlertService)
/* harmony export */ });
/* harmony import */ var _app_utils_cekInputValid_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../app/utils/cekInputValid.js */ "./src/app/utils/cekInputValid.js");
...
class AlertService {
  ...
  tampilkanErrorPenjumlahan = (input, angka) => {
    const hasil = input.reduce((pesan, nilai, index) => {
      if ((0,_app_utils_cekInputValid_js__WEBPACK_IMPORTED_MODULE_0__.cekInputValid)(angka[index])) {
        return pesan + "";
      } else {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ CalculatorService)
/* harmony export */ });
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ JokesService)
/* harmony export */ });
class JokesService {
  constructor() {
...
(0,_app_app_js__WEBPACK_IMPORTED_MODULE_0__["default"])(alertService, calculatorService, jokesService);

alert("Selamat Datang WPU");
